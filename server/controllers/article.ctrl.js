...
module.exports = {
    addArticle: (req, res, next) => {
        let { text, title, stars, description } = req.body
        //let obj = { text, title, stars, description, feature_img: _feature_img != null ? `/uploads/${_filename}` : '' }
        if (req.files.image) {
            cloudinary.uploader.upload(req.files.image.path, (result) => {
                let obj = { text, title, stars, description, feature_img: result.url != null ? result.url : '' }
                saveArticle(obj)
            ...
            saveArticle({ text, title, stars, description, feature_img: '' })
        }
